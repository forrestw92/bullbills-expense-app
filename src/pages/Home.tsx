  ...
  return (
    <div className="flex flex-col w-full text-gray-400">
      <div className="grid grid-cols-3 grid-rows-3 gap-5">
        <div className="col-span-1 bg-slate-800 rounded-md shadow-xl transition-all hover:scale-105">
        ...
        <div className="relative col-span-1 bg-slate-800 rounded-md shadow-xl transition-all hover:scale-105">
        ...
        <div className="col-span-2 row-span-2 bg-purple-900 rounded-md shadow-xl p-5 shadow-inner shadow-2xl shadow-slate-900">
